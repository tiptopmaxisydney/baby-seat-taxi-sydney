...
export const metadata: Metadata = {
  title: "Contact Us | Baby Seat Taxi Sydney",
  description: "Contact Baby Seat Taxi Sydney by phone, email or WhatsApp to book a baby capsule or child seat taxi, or ask a question.",
};
  ...
  return (
    <>
      <ServiceHero
        ...
        title="Contact Us"
        description="Reach our booking team by phone, email or WhatsApp for family transport across Sydney."
      ...
      <section className="wt-section">
        <div className="container">
          ...
          <div style={{ marginTop: 48, maxWidth: 700 }}>
            ...
            <p>
              For booking enquiries, please include your pickup and destination, your child&apos;s age, the seat type needed (baby
              capsule, child seat or booster), preferred pickup time and number of passengers so our team can respond with an
              accurate quote.
            </p>
