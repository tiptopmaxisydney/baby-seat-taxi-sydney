        ...
        <div className="container">
          <div style={{ maxWidth: 800 }}>
            <p style={{ color: "var(--wt-muted)", fontSize: "0.85rem" }}>
              This page provides a general outline of how {siteConfig.legalName}, operator of Baby Seat Taxi Sydney, approaches
              privacy. It is intended as general information and should be reviewed and confirmed against our current, complete
              privacy policy or by contacting us directly.
            </p>
            ...
            <p>
              Information collected is used to process bookings, allocate suitable vehicles and child restraints, communicate with
              you about your trip, and improve our services. We do not sell personal information to third parties.
            </p>

            <h2>Sharing of Information</h2>
            <p>
              Limited information may be shared with drivers or operators involved in fulfilling your booking, and where required,
              with relevant authorities or service partners, with your consent or as required by law.
            </p>
            ...
            <h2>Your Rights</h2>
            <p>
              You may request access to, or correction of, the personal information we hold about you by contacting us using the
              details below.
            </p>
