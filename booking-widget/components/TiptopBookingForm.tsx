  ...
  return (
    <Fragment>
      <Spin spinning={loadingSubmit}>
        <div id="top-booking-form">
          ...
          >
            ...
            />
            {distance ? (
              <p className="mt-3 flex items-center gap-2 text-sm font-medium text-[#5b6472]">
                <span className="inline-flex h-1.5 w-1.5 flex-shrink-0 rounded-full bg-[#f78d1e]" />
                Total distance:{" "}
                <span className="font-semibold text-[#1d3649]">
      ...
      <Modal
        ...
        styles={{ content: { borderRadius: 22, padding: 0, overflow: "hidden" } }}
      >
        <div className="px-6 pt-7 pb-6 text-center">
          ...
          <button
            type="button"
            onClick={handleOk}
            className="w-full rounded-full bg-[#f78d1e] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#c9720a]"
          >
            Back to Home
          </button>
        </div>
