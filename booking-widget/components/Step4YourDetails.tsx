  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        <PassengerIcon />
        <span className="fw-semibold text-[#1d3649]">Passenger details</span>
      </div>
      ...
      <div className="phone_input_detail flex items-center gap-2 border border-slate-200 rounded-xl px-3 h-[44px] mt-3 transition-colors focus-within:border-[#1d3649] focus-within:ring-2 focus-within:ring-[#1d3649]/10">
        <span className="flex-shrink-0 flex items-center">
          <CallIcon />
        </span>
        <Form.Item
      ...
      <div className="flex items-center gap-2 border border-slate-200 rounded-xl px-3 h-[44px] mt-3 transition-colors focus-within:border-[#1d3649] focus-within:ring-2 focus-within:ring-[#1d3649]/10">
